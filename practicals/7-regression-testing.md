...
Consider the method [`StringUtils.duplicateLetters`](../code/lib/src/main/java/uk/ac/shef/com3529/stringutils/StringUtils.java), for which you are given the following test suite.
