...
|6 | [**Regression Testing**](slides/8-regression-testing.pdf) <ul><li>Test minimisation</li><li>Test prioritisation</li><li>Test selection</li></ul>| [Regression Testing in Practice](practicals/) ([Solutions](practicals/)) |
